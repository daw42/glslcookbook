...
extern GLvoid* (CODEGEN_FUNCPTR *_ptrc_glMapBuffer)(GLenum , GLenum );
...
extern GLvoid* (CODEGEN_FUNCPTR *_ptrc_glMapBufferRange)(GLenum , GLintptr , GLsizeiptr , GLbitfield );
