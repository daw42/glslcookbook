...
static int Load_Version_4_3()
{
	...
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glTextureStorage2DEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLenum , GLsizei , GLenum , GLsizei , GLsizei ))IntGetProcAddress("glTextureStorage2DEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glTextureStorage3DEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLenum , GLsizei , GLenum , GLsizei , GLsizei , GLsizei ))IntGetProcAddress("glTextureStorage3DEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glDebugMessageControl = (void (CODEGEN_FUNCPTR *)(GLenum , GLenum , GLenum , GLsizei , const GLuint *, GLboolean ))IntGetProcAddress("glDebugMessageControl");
	...
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glClearNamedBufferSubDataEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLenum , GLenum , GLenum , GLsizeiptr , GLsizeiptr , const void *))IntGetProcAddress("glClearNamedBufferSubDataEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glDispatchCompute = (void (CODEGEN_FUNCPTR *)(GLuint , GLuint , GLuint ))IntGetProcAddress("glDispatchCompute");
	...
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glGetNamedFramebufferParameterivEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLenum , GLint *))IntGetProcAddress("glGetNamedFramebufferParameterivEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glGetInternalformati64v = (void (CODEGEN_FUNCPTR *)(GLenum , GLenum , GLenum , GLsizei , GLint64 *))IntGetProcAddress("glGetInternalformati64v");
	...
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glTexStorage2DMultisample = (void (CODEGEN_FUNCPTR *)(GLenum , GLsizei , GLenum , GLsizei , GLsizei , GLboolean ))IntGetProcAddress("glTexStorage2DMultisample");
	...
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glTextureStorage3DMultisampleEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLenum , GLsizei , GLenum , GLsizei , GLsizei , GLsizei , GLboolean ))IntGetProcAddress("glTextureStorage3DMultisampleEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glTextureView = (void (CODEGEN_FUNCPTR *)(GLuint , GLenum , GLuint , GLenum , GLuint , GLuint , GLuint , GLuint ))IntGetProcAddress("glTextureView");
	...
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glVertexArrayVertexAttribFormatEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLuint , GLint , GLenum , GLboolean , GLuint ))IntGetProcAddress("glVertexArrayVertexAttribFormatEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glVertexArrayVertexAttribIFormatEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLuint , GLint , GLenum , GLuint ))IntGetProcAddress("glVertexArrayVertexAttribIFormatEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glVertexArrayVertexAttribLFormatEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLuint , GLint , GLenum , GLuint ))IntGetProcAddress("glVertexArrayVertexAttribLFormatEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glVertexArrayVertexAttribBindingEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLuint , GLuint ))IntGetProcAddress("glVertexArrayVertexAttribBindingEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	_ptrc_glVertexArrayVertexBindingDivisorEXT = (void (CODEGEN_FUNCPTR *)(GLuint , GLuint , GLuint ))IntGetProcAddress("glVertexArrayVertexBindingDivisorEXT");
	/*An EXT_direct_state_access-based function. Don't count it.*/	return numFailed;
}
